    ...
    render() {
      return (
        <Page>
          <Helmet title="トピック作成" />
          <Paper>
            <Mutation<G.CreateTopicNormalMutation | G.CreateTopicOneMutation
              , G.CreateTopicNormalMutationVariables | G.CreateTopicOneMutationVariables>
              ...
              onCompleted={x => {
                this.props.history
                  .push(`/topic/${("createTopicNormal" in x ? x.createTopicNormal : x.createTopicOne).id}`);
              }}
            >
              {(submit, { error }) => {
                return (<form>
